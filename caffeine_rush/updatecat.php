      ...
      <section class="wrapper">
        ...
        <div class="row">
          ...
          <div class="col-lg-9 col-md-12">
              ...
              <div class="panel-body" id="product-panel">
                <div class="padd">
                  ...
                  <div class="form quick-post">
                    ...
                    <!-- ------------------------------------------------------- -->
                    <form class="form-horizontal" action="updtprdct.php" method="post">
                      <!-- Title -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="title">Product Id</label>
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="title" name="pr_id" required>
                        </div>
                      </div>
                      <!-- Content -->
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="content" name="pr_name" disabled>
                        </div>
                      </div>
                      <!-- Cateogry -->
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <select class="form-control" name="pr_cat" disabled>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="tags" name="pr_price" disabled>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-lg-offset-2 col-lg-9">
                          <button type="submit" class="btn btn-primary" name="up_pr">Update</button>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <div class="pull-left">update Category</div>
                <div class="widget-icons pull-right">
              ...
              <div class="panel-body" id="cat-panel">
                <div class="padd">
                  ...
                  <div class="form quick-post">
                    <!-- Edit profile form (not working)-->
                    <!-- ------------------------------------------------- -->
                    <form class="form-horizontal" action="updt_cat.php" method="post">
                      <!-- Title -->
                      <div class="form-group">
                        <label class="control-label col-lg-2" for="title">Category Id</label>
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="title" name="cat_id" required>
                        </div>
                      </div> 
                      <!-- Content -->
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" id="content" name="cat_name" disabled>
                        </div>
                      </div>
                      <!-- Tags -->
                      ...
                      <div class="form-group">
                        <!-- Buttons -->
                        <div class="col-lg-offset-2 col-lg-9">
                          <button type="submit" class="btn btn-primary" name="updtcgr">Update</button>
                          <button type="reset" class="btn btn-default">Reset</button>
                        </div>
                      </div>
                    </form>
            ...
            <div class = "button-upd">
              <div>
                <form action="updlt.php" method="post">
                  <button type="submit" class="btn btn-success button" name="add">Add Products</button>
