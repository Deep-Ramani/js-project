...
<body>
	...
	<section id="container" class="container">
		...
		<div class="row">
			<div class="col-lg-12"><h1 class="h1prfrm">UPDATE PRODUCT</h1></div>
					...
					<div class="panel-body" id="product-panel">
						<div class="padd">
							...
							<div class="form quick-post">
								...
								<!-- ------------------------------------------------------- -->
								<form class="form-horizontal" action="insert_updtd.php" method="post">
									<!-- Title -->
									<div class="form-group">
										<label class="control-label col-lg-2" for="title">Product Id</label>
										<div class="col-lg-10">
											<input type="text" class="form-control" id="title" value="<?php echo $_SESSION['id']; ?>" name="prdct_id">
										</div>
									</div>
									<!-- Content -->
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" id="content" value="<?php echo $_SESSION['name']; ?>" name="pr_name">
										</div>
									</div>
									<!-- Cateogry -->
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<select class="form-control" value="<?php echo $_SESSION['cat'];?>" name="pr_category">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" class="form-control" id="tags" value="<?php echo $_SESSION['price']; ?>" name="pr_price">
										</div>
									</div>
