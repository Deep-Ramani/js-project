                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                   <div class="form-top">
                      <div class="form-top-left">
                         ...
                         <p>Make sure to remember password !!!</p>
                     </div>
                 ...
                 <div class="form-bottom">
                  <form role="form" action="rst.php" method="post" class="login-form">
                    <div class="form-group">
                        <label class="sr-only" for="form-username"><!-- Username --></label>
                        <input type="password" name="rpwd" placeholder=" New Password..." class="form-username form-control" id="rpwd" required>
                    </div>
                    <div class="form-group">
                        <!-- <label class="sr-only" for="form-password">Password</label> -->
                        <input type="password" name="rcpwd" placeholder="Confirm Password..." class="form-password form-control" id="rcpwd" required>
